...
const ManualPaymentsPieChart = () => {
  ...
  if (getMonthlyPaymentsCount(residencyPaymentRequests || []) === 0) {
    return (
      <Heading
        color="#1e6e7d"
        fontSize="35px"
